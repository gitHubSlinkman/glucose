...
source("D:/R-Projects/glucose/functions/compute_statistics.R")  # Compute
                                                                #  summary
                                                                # statistics
source("D:/R-Projects/glucose/functions/plot_last_007_days.R")  # Plot ts.
...
```{r dewtermine_file_path_to_the_data}
...
plot_last_007_days( Readings )
```

### Seven days summary statistics

```{r ummarize last_7_days} 
